...
class TestHomeView:
    ...
    def test_home_redirects_to_setup_when_no_users(self, client: Client) -> None:
    ...
    def test_home_shows_welcome_when_users_exist(self, client: Client) -> None:
    ...
    def test_home_shows_login_link_when_not_authenticated(self, client: Client) -> None:
    ...
    def test_home_shows_register_link_when_no_users(self, client: Client) -> None:
    ...
    def test_home_shows_dashboard_link_when_authenticated(self, client: Client) -> None:
